...
void ATimeAttackPawn::DisplayDebug(UCanvas* Canvas, const FDebugDisplayInfo& DebugDisplay, float& YL, float& YPos)
{
	...
	{
		UTelemetryComponent* TelemetryComponent = Cast<UTelemetryComponent>(GetComponentByClass(UTelemetryComponent::StaticClass()));
		if (TelemetryComponent != nullptr)
		{
			// Draw telemetry.
